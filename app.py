...
for i, frame in enumerate(frames):
    ...
    total_score = (sharpness _0.3 + contrast_ 0.3 + brightness_score _0.2 + edge_density_ 1000 * 0.2)
...
def search_objects(self, video_path, object_names, min_confidence=0.7):
    ...
    try:
        ...
        placeholders = ','.join(['?' for _in object_names])
        ...
        with gr.Row():
            ...
            with gr.Column(scale=1):
                ...
                **🎯 Auto-Detection Info:**
                ...
                _Smart filtering automatically adjusts confidence levels for better accuracy._
